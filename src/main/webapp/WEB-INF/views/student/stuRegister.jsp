                            ...
                            <div>
                                <table id="registerList">
									...
									<tr>
										<th>성별</th>
										<td>
										<input type="radio" name="stu_gender" value="male"> 남
      									<input type="radio" name="stu_gender" value="female"> 여
										</td>
									</tr>
									<tr>
										<th>학생상태</th>
										<td>
											<select class="conditionSelect" name="stu_condition">
									...
									<tr>
										<td colspan="2">
											<input type="button" value="과목추가" onclick="#"/>
