...
<br>
<table id="goodList" style="width:40%;">
<tr>
	<th style="width:30%;">직원명</th>
	<td style="width:70%; text-align:center;">${empName}</td>
	<td id=empNo class="hidden">${empNo}</td>
</tr>
</table>
 ...
 <!-- 	<div style="float:right; font-size:20px; font-weitht:bold;">
	...
	<table id="goodList">		
		...
		<tr >
			...
			<button onclick="empLogBack()" class="goodRegister">목록</button>
			<input type="button" value="등록" onclick="empLogRegister()" >
			</th>
		</tr>
			<tr>
				<th>작성일</th>
...
function empLogRegister(){
		var emp_no=$("#empNo").html();
		 window.open("empLogRegister.go?emp_no="+emp_no,"new","width=1000, height=600, resizable=no, scrollbars=no, status=no, location=no, directories=no;");
