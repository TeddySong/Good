...
// 일정 리스트 이동 
	 ...
	 * 
	 * @ResponseBody public String homeReg (@RequestParam(value="cli_name",required
	 * = false) String cli_name, @RequestParam(value="cli_phone",required = false)
	 * String cli_phone,
	 * 
	 * @RequestParam(value="cli_req",required = false) String
	 * cli_req,@RequestParam(value="sub_no", required = false) ArrayList<Integer>
	 * sub_no ) { HashMap<String, Object> map = new HashMap<String, Object>();
	 * 
	 * 
	 ...
	 * System.out.println(string); // } String msg = "상담신청 오류발생.";
	 * if(service.cliReg(map)>0) { msg = "상담신청을 완료했습니다. 감사합니다.";
	 * service.cliRegCo(sub_no); }
	 * 
	 * map.put("msg", msg);
	 * 
